...
$(document).ready((function(){$(".header-list,.arrow").on("click","a",(function(t){var e=$(this).attr("href"),o=$(e).offset().top;$("body,html").animate({scrollTop:o},1500)}))}));
$(document).ready((function(){var e=$(".burger_alert"),i=$("#menu_mobile"),l=($("#burger_close"),$(".header-burger__line"));e.on("click",(function(){i.toggleClass("menu-mobile_active"),l.toggleClass("header-burger__line_active")})),$(".menu-list__item").on("click",(function(){i.removeClass("menu-mobile_active"),l.removeClass("header-burger__line_active");}))}));
$(document).ready((function(){$(".follow-slider").slick({slidesToShow:7,slidesToScroll:1,autoplay:!0,autoplaySpeed:2e3,arrows:!1,speed:2e3,responsive:[{breakpoint:1151,settings:{slidesToShow:5}},{breakpoint:951,settings:{slidesToShow:3}},{breakpoint:551,settings:{slidesToShow:2}}]})}));
$(document).ready((function(){$(".hero-slider").slick({slidesToShow:1,slidesToScroll:1,autoplay:!0,autoplaySpeed:300,arrows:!1,fade:!0,speed:300,cssEase:"easeInOutBack",adaptiveHeight:!0,infinite:!1,edgeFriction:1}),$(".hero-slider").on("beforeChange",(function(e,o,a,i){i===o.slideCount-1&&(o.autoPlay=!1)}))}));
...
$(window).on("load",(function(){$((function(){$("#container1").twentytwenty(),$("#container2").twentytwenty()}))}));
$((function(){let o=$("#up");$(window).scroll((function(){$(this).scrollTop()>10?(o.addClass("up_flex"),o.show("slow")):o.hide("slow")})),o.on("click",(function(){$("html, body").animate({scrollTop:0},800)}))}));
$(document).ready((function(){$("#contacts-form").validate({rules:{username:{required:!0,minlength:2,maxlength:15},userphone:{required:!0},useremail:{required:!0,email:!0}},messages:{username:{required:"",minlength:jQuery.validator.format(""),maxlength:jQuery.validator.format("")},userphone:"Введите корректные данные",useremail:{required:"Введите корректный email",email:"Введите корректный email"}},submitHandler: function (e) {$.ajax({url: 'mail.php',type: 'POST',data: $('#contacts-form').serialize(),success: function (data) {$("input").val("");}});
