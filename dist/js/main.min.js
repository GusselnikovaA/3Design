...
$(document).ready((function(){$(".header-list,.arrow").on("click","a",(function(t){t.preventDefault();var e=$(this).attr("href"),o=$(e).offset().top;$("body,html").animate({scrollTop:o},1500)}))}));
