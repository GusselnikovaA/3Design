...
$(document).ready((function(){var e=$(".burger_alert"),i=$("#menu_mobile"),l=($("#burger_close"),$(".header-burger__line"));e.on("click",(function(){i.toggleClass("menu-mobile_active"),l.toggleClass("header-burger__line_active")})),$(".menu-list__item").on("click",(function(){i.removeClass("menu-mobile_active")}))}));
